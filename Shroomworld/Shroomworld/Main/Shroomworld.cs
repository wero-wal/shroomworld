...
namespace Shroomworld {
    public class Shroomworld : Game {
        ...
        /* The update method to call in the Update method. I have opted for this instead of a
           GameState enum and an if statement in the Update function because it uses less
           processing time. */
        ...
        private bool TryLoadGameFiles() {
            ...
            && FileManager.LoadTypes<TileType>(out _tileTypes)
